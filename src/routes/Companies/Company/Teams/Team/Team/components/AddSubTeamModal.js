...
export class AddSubTeamModal extends Component {
  static propTypes = {
    ...
    return (
      ...
      >
        <Form onSubmit={(e) => {
          ...
          <ModalHeader toggle={toggle}>{formatMessage('Add team to')} {teamName}</ModalHeader>
          <ModalBody>
            <FormGroup>
              <Select
                options={userOptions}
...
export default injectIntl(AddSubTeamModal);
